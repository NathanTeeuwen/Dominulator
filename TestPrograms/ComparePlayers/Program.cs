...
namespace Program
{
    ...
    {        
        ...
        {            
            ...
            {
                var player1 = Strategies.UnivesityStewardCityMountebank.Player();
                var player2 = Strategies.AltarStewardCityMountebank.Player();
                //var player2 = Strategies.BigMoneyWithCard.Player(Cards.Mountebank);
