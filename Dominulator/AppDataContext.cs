...
namespace Dominulator
{
        ...
        : DependencyObject
    {
        ...
        {
            if (this.CurrentPageConfig.Value == Dominulator.PageConfig.AllCards || this.CurrentPageConfig.Value == Dominulator.PageConfig.CurrentDeck)
            {
        ...
        public void ShowReport()
        {
            ...
            this.CurrentPageConfig.Value = Dominulator.PageConfig.Report;
        }
