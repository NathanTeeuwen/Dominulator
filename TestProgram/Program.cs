...
namespace Program
{
    ...
    {        
        static void Main()
        {
            ...
            //ComparePlayers(Strategies.LookoutSalvagerLibraryHighwayFestival.Player(), Strategies.BigMoneySingleWitch.Player(), useColonyAndPlatinum: false, createHtmlReport: false, numberOfGames:10000);
