...
{    
    public class RatsUpgradeBazaar
        : Strategy
    {
        ...
        static ICardPicker PurchaseOrder()
        {
            return new CardPickByPriority(
                        ...
                        CardAcceptance.For(Cards.Upgrade, gameState => CountAllOwned(Cards.Upgrade, gameState) < 2),
                        CardAcceptance.For(Cards.Gold),               
                        CardAcceptance.For(Cards.Bazaar),                                   
                        CardAcceptance.For(Cards.Rats, gameState => CountAllOwned(Cards.Rats, gameState) == 0 && CountAllOwned(Cards.Upgrade, gameState) == 0),
        ...
        static CardPickByPriority ActionOrder()
        {
            return new CardPickByPriority(
                CardAcceptance.For(Cards.Bazaar),
                CardAcceptance.For(Cards.Upgrade, gameState => CountInHand(Cards.Estate, gameState) > 0),
